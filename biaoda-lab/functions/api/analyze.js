// 📎 Cloudflare Pages Functions 版本 · 逻辑与 api/analyze.js（Vercel 版）保持一致
// 📍 两版需同步维护：Prompt 模块正文 / Module C 阈值 / 契约校验规则不允许出现差异。
//
...
// ============================================================
// Prompt 工程 · 8 模块正文（与 js/api.js / api/analyze.js 保持完全一致）
// ============================================================
...
/** 契约"宽容修补"：把契约字段补全到 PRD §7.2 前端期望形状 */
...
export async function onRequestPost({ request, env }) {
  ...
  const { transcript, scene, level_segment, topic } = body || {};
